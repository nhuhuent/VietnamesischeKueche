    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                intent = new Intent(Vegatarisch_Gerichte_Activity.this, VietnamesichesKueche_Activity.class);
        ...
        canhchuanamchayImg.setOnClickListener((View view) -> {
            intent = new Intent(Vegatarisch_Gerichte_Activity.this, Reis_Vege_CanhChuaNamChay_Activity.class);
        ...
        dauhusotcaImg.setOnClickListener((View view) -> {
            intent = new Intent(Vegatarisch_Gerichte_Activity.this, Reis_Vege_DauHuSotCa_Activity.class);
            intent.putExtra("chooseActivity",2 );
            startActivity(intent);
        });
        ...
        mienchayraucuImg.setOnClickListener((View view) -> {
            intent = new Intent(Vegatarisch_Gerichte_Activity.this, Nudeln_Vege_MienChayRauCu_Activity.class);
            intent.putExtra("chooseActivity",2 );
            startActivity(intent);
        });
        ...
        mienchayxaoImg.setOnClickListener((View view) -> {
            intent = new Intent(Vegatarisch_Gerichte_Activity.this, Nudeln_Vege_MienChayXao_Activity.class);
            intent.putExtra("chooseActivity",2 );
            startActivity(intent);
        });
        ...
        chagiochayImg.setOnClickListener((View view) -> {
            intent = new Intent(Vegatarisch_Gerichte_Activity.this, Spezialitaet_Vege_ChaGioChay_Activity.class);
            intent.putExtra("chooseActivity",2 );
            startActivity(intent);
        });
        ...
        goicuonchayImg.setOnClickListener((View view) -> {
            intent = new Intent(Vegatarisch_Gerichte_Activity.this, Spezialitaet_Vege_GoiCuonChay_Activity.class);
            intent.putExtra("chooseActivity",2 );
            startActivity(intent);
        });
    }
